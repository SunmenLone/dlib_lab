...
# predicter_path = current_path
# + '/models/shape_predictor_5_face_landmarks.dat'
# 检测人脸特征点的模型放在当前文件夹中
predicter_path = current_path + '/models/shape_predictor_68_face_landmarks.dat'
face_file_path = current_path + '/faces/bush.jpg'  # 要使用的图片，图片放在当前文件夹中
...
for image in images:
    ...
    cv_bgr_image = cv2.cvtColor(
        cv_rgb_image, cv2.COLOR_RGB2BGR)  # opencv下颜色空间为bgr，所以从rgb转换为bgr
